        ...
        <div class="card-body">
            <form action="{{ route('appointments.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="egn" name="egn" class="form-control @error('egn') is-invalid @enderror" value="{{ old('egn') }}" maxlength="10">
                            @error('egn')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="appointment_datetime" name="appointment_datetime" class="form-control @error('appointment_datetime') is-invalid @enderror" value="{{ old('appointment_datetime') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="notification_type_id" name="notification_type_id" class="form-control @error('notification_type_id') is-invalid @enderror">
                                ...
                                @foreach($notificationTypes as $type)
                                    <option value="{{ $type->id }}" {{ old('notification_type_id') == $type->id ? 'selected' : '' }}>{{ $type->name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('appointments.index') }}" class="btn btn-secondary">Отказ</a>
                </div>
            </form>
        </div>
    </div>
